...
return [
    'packages' => [
        ...
        'affichagetarifs' => [
            'composerName' => 'affichagetarifs',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/affichagetarifs/',
            'suggestions' => [],
        ],
        'annuairevdncan' => [
            'composerName' => 'annuairevdncan',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/annuairevdncan/',
            'suggestions' => [],
        ],
        'bootstrap_package' => [
        ...
        'collectedechetscan' => [
            'composerName' => 'collectedechetscan',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/collectedechetscan/',
            'suggestions' => [],
        ],
        'conseildelib' => [
            'composerName' => 'conseildelib',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/conseildelib/',
            'suggestions' => [],
        ],
        'espacepresse' => [
            'composerName' => 'espacepresse',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/espacepresse/',
            'suggestions' => [],
        ],
        'eventcalendar' => [
            'composerName' => 'eventcalendar',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/eventcalendar/',
            'suggestions' => [],
        ],
        'extendnewsvdncan' => [
            'composerName' => 'extendnewsvdncan',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/extendnewsvdncan/',
            'suggestions' => [],
        ],
        'extension_builder' => [
        ...
        'googlesearchvdncan' => [
            'composerName' => 'googlesearchvdncan',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/googlesearchvdncan/',
            'suggestions' => [],
        ],
        'gridelements' => [
        ...
        'horairettaddress' => [
            'composerName' => 'horairettaddress',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/horairettaddress/',
            'suggestions' => [],
        ],
        'meselus' => [
            'composerName' => 'meselus',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/meselus/',
            'suggestions' => [],
        ],
        'restaurantscolaireniort' => [
            'composerName' => 'restaurantscolaireniort',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/restaurantscolaireniort/',
            'suggestions' => [],
        ],
        'sectorisationvdn' => [
            'composerName' => 'sectorisationvdn',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/sectorisationvdn/',
            'suggestions' => [],
        ],
        'structuredata' => [
            'composerName' => 'structuredata',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/structuredata/',
            'suggestions' => [],
        ],
        'tarifsvdncan' => [
            'composerName' => 'tarifsvdncan',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/tarifsvdncan/',
            'suggestions' => [],
        ],
        'templateniortagglo' => [
            'composerName' => 'templateniortagglo',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/templateniortagglo/',
            'suggestions' => [],
        ],
        'vdncan_gestelus' => [
            'composerName' => 'vdncan_gestelus',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/vdncan_gestelus/',
            'suggestions' => [],
        ],
        'vhs' => [
